...
$sql=mysqli_query($conexion,"SELECT nombre, aes_decrypt(unhex(nombre),'hunter2') AS descifrado FROM user WHERE correo ='$actualsesion'");

if($row= mysqli_fetch_array($sql)){
$user=$row[1];
}
$sql=mysqli_query($conexion,"SELECT nombre, aes_decrypt(unhex(cargo),'hunter2') AS descifrado FROM user WHERE correo ='$actualsesion'");
...
<div id="wrapper">
    ...
    <div class="sidebar-brand-text mx-3"><?php echo $user?> </div>
</a>
...
<div class="sidebar-brand-text mx-3"><?php echo $cargo?> </div>
</div>
